...
<head>
    ...
    <style>
        ...
        .studio-badge { background: var(--edco-primary); color: white; padding: 25px; border-radius: 20px; display: inline-block; text-align: center; box-shadow: 0 20px 40px rgba(79, 70, 229, 0.2); }
        .feature-item { padding: 20px; border-radius: 15px; background: #f8fafc; border: 1px solid #e2e8f0; transition: 0.3s; height: 100%; }
        .feature-item:hover { border-color: var(--edco-primary); background: #fff; box-shadow: 0 10px 30px rgba(0,0,0,0.05); }
        .feature-icon { width: 50px; height: 50px; background: #fff; color: var(--edco-primary); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin-bottom: 15px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); }
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7" data-aos="fade-up">
                        ...
                        <p class="lead text-white-50 mb-5">15 years of excellence in architecting high-scale software, secure fintech labs, and robust cloud nodes for global leaders.</p>
                        <div class="d-flex flex-column flex-sm-row gap-3">
                            <a href="services" class="btn btn-edco">Explore Solutions</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5" data-aos="fade-right">
                        <div class="position-relative">
                            <!-- Team/Office Image -->
                            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=700" class="img-fluid rounded-4 shadow-lg" alt="Edco Venture Studio">
