...
<head>
    ...
    <title>Ekkilsia | Edoc Ventures - Next-Gen Church Administration Suite</title>
                ...
                <div class="row align-items-center g-5">
                    <div class="col-lg-6" data-aos="fade-right">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-3">
                            <a href="/quation" class="btn-demo-live"><i class="fa-solid fa-play-circle me-2"></i> Experience Live Demo</a>
                            <a href="/quation" class="btn btn-outline-dark px-4 py-3 border-2 fw-bold rounded-3">Request Pricing</a>
                        </div>
                    ...
                    <div class="col-lg-6" data-aos="zoom-in">
                        <img src="/assets/img/ekkilsia-crm-ghana.webp" class="img-fluid rounded-4 shadow-lg border" alt="Ministry Engagement">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                        <div class="feature-card">
                            ...
                            <p class="small text-muted mb-0">Maintain records with zero downtime. Built on Edoc Cloud Nodes with high-end encryption for sensitive member data.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="impact-box" data-aos="fade-up">
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            ...
                            <a href="/quation" class="btn btn-light btn-lg px-4 py-3 mt-5 fw-bold text-primary">Request Individual Branch Demo</a>
                        </div>
                        <div class="col-lg-5 d-none d-lg-block">
                            <img src="/assets/img/ghana-church-community.webp" class="img-fluid rounded-4 shadow-lg" alt="Faith Community">
                        </div>
                    </div>
                </div>
            </div>
