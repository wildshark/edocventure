...
<head>
    ...
    <title>Swap Labs | Edco Ventures - Real-time currency exchange and liquidity management</title>
            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 text-center" data-aos="zoom-in">
                        <img src="assets/img/fintech-swaplabs-qr-scanner.png" class="img-fluid rounded-4 shadow-lg qr-mockup" alt="Quest Pay QR Scanner">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="impact-bg" data-aos="fade-up">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 d-none d-lg-block text-center">
                            <img src="assets/img/fintech-swaplabs-digital-economy.png" class="img-fluid rounded-4 shadow-lg border-primary" alt="Digital Economy">
                        </div>
                    </div>
                </div>
            </div>
