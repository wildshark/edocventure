...
<head>
    ...
    <title>Quest Pay | Edoc Ventures - Scan-to-Pay & Crowdfunding Ecosystem</title>
            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-7" data-aos="fade-right">
                        ...
                        <h1 class="display-3 mb-4">Payments that Bind <span class="text-primary">Business & Purpose.</span></h1>
                    ...
                    <div class="col-lg-5 text-center" data-aos="zoom-in">
                        <img src="/assets/img/fintech-questpay-qr-scanner.webp" class="img-fluid rounded-4 shadow-lg qr-mockup" alt="Quest Pay QR Scanner">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="impact-bg" data-aos="fade-up">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 d-none d-lg-block text-center">
                            <img src="/assets/img/fintech-questpay-digital-economy.webp" class="img-fluid rounded-4 shadow-lg border-primary" alt="Digital Economy">
                        </div>
                    </div>
                </div>
            </div>
