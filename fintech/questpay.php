            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 text-center" data-aos="zoom-in">
                        <img src="/assets/img/fintech-questpay-qr-scanner.webp" class="img-fluid rounded-4" alt="Quest Pay QR Scanner">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="impact-bg" data-aos="fade-up">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 d-none d-lg-block text-center">
                            <img src="/assets/img/fintech-questpay-digital-economy.webp" class="img-fluid rounded-4" alt="Digital Economy">
                        </div>
                    </div>
                </div>
            </div>
