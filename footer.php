...
.footer-links a:hover { color: var(--edco-primary, #4f46e5); padding-left: 5px; }
...
.social-circle:hover { background: var(--edco-primary, #4f46e5); transform: translateY(-3px); }
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <ul class="footer-links">
                            <li><a href="?page=elearningpro">eLearning Pro</a></li>
                            <li><a href="?page=sms">SMSBox-247</a></li>
                            <li><a href="?page=saas/ekkilsia">Ekkilsia CRM</a></li>
                            <li><a href="?page=saas/mylibrary">myLibrary</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-6">
                        <h3 class="footer-heading">Fintech</h3>
                        <ul class="footer-links">
                            <li><a href="?page=swaplabs">Swap Labs</a></li>
                            <li><a href="?page=questpay">Quest Pay</a></li>
                            <li><a href="?page=fintech/cashwired">CashWired</a></li>
                            <li><a href="?page=cloud/virtualhode">Digital Nodes</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="newsletter-box p-4 rounded-4 shadow-sm">
                            ...
                            <form id="newsletterForm" class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" id="newsletterBtn" class="btn btn-primary px-3" style="background-color: var(--edco-primary, #4f46e5); border: none;">Join</button>
                                </div>
                ...
                <div class="footer-bottom">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                            &copy; 2026 Edco Ventures. All Global Rights Reserved.
                        </div>
