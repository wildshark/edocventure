...
<head>
    ...
    <title>Edco Ventures | Global Enterprise IT & Venture Studio</title>
    <meta name="description" content="15 years of engineering excellence in SaaS, Fintech, and Cloud Infrastructure.">
    <meta property="og:title" content="Edco Ventures | Global Enterprise IT & Venture Studio">
    <meta property="og:description" content="15 years of engineering excellence in SaaS, Fintech, and Cloud Infrastructure.">
    <meta property="og:image" content="https://www.edocventures.com/assets/img/EDCO.png">
    ...
    <style>
        :root {
            --edco-primary: #4f46e5; /* Modern Indigo */
            --edco-cyan: #06b6d4;
            --edco-dark: #0f172a;    
            --edco-topbar: #1e293b;
            --edco-footer: #020617;
        ...
        h1, h2, h3, h4, h5, .display-5 { font-family: 'Outfit', sans-serif; font-weight: 800; color: var(--edco-dark); letter-spacing: -0.02em; }
        .text-primary { color: var(--edco-primary) !important; }
        .bg-light-subtle { background-color: var(--edco-light); }
        ...
        .btn-edco { background: var(--edco-primary); color: white; border-radius: 10px; padding: 14px 32px; font-weight: 600; border: none; transition: 0.3s; text-decoration: none; display: inline-block; }
        .btn-edco:hover { background: #4338ca; transform: translateY(-2px); box-shadow: 0 10px 20px rgba(79, 70, 229, 0.3); color: white; }

        /* --- STUDIO SECTION --- */
        .studio-badge { background: var(--edco-primary); color: white; padding: 25px; border-radius: 20px; display: inline-block; text-align: center; }
        ...
        .feature-icon-box { width: 60px; height: 60px; background: #eef2ff; color: var(--edco-primary); border-radius: 15px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin-bottom: 20px; }
        ...
        .product-item:hover { border-color: var(--edco-primary); box-shadow: 0 10px 25px rgba(0,0,0,0.05); }
        .product-icon { color: var(--edco-primary); font-size: 1.8rem; margin-bottom: 15px; }

        /* --- FOOTER --- */
        .footer-main { background: var(--edco-footer); color: #94a3b8; padding: 100px 0 0 0; }
        ...
        .footer-links a:hover { color: var(--edco-primary); padding-left: 5px; }
        ...
        .social-circle:hover { background: var(--edco-primary); transform: translateY(-3px); }
            ...
            <div class="container position-relative" style="z-index: 2;">
                <div class="row align-items-center text-center text-lg-start">
                    <div class="col-lg-7" data-aos="fade-up">
                        ...
                        <p class="lead text-white-50 mb-5">From multi-currency fintech labs to secure education ecosystems, Edco Ventures engineers high-scale software that transforms industries.</p>
                        <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
                            <a href="?page=quation" class="btn btn-edco">Explore the Ecosystem</a>
                            <a href="?page=quation" class="btn btn-outline-light px-4 py-3 border-2 fw-bold text-decoration-none">
                                <i class="fa-solid fa-play me-2"></i> Watch Our Vision
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-5 d-none d-lg-block" data-aos="zoom-in">
                        <img src="assets/img/data-analytics-hero.png" class="img-fluid rounded-4 shadow-lg border border-secondary border-opacity-25" alt="Data Analytics Dashboard">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5" data-aos="fade-right">
                        <div class="position-relative">
                            <img src="assets/img/ghana-team-venture.png" class="img-fluid rounded-4 shadow-lg" alt="Edco Team">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <a href="?page=elearningpro" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <a href="?page=sms" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <a href="?page=eaccounting" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <a href="?page=ebankinghub" class="product-item">
                    ...
                    <!-- Fintech Group -->
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <a href="?page=swaplabs" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <a href="?page=questpay" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <a href="?page=cloud/virtualhode" class="product-item">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <a href="?page=cloud/vod" class="product-item">
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 order-2 order-lg-1" data-aos="fade-right">
                        <h6 class="text-primary fw-bold text-uppercase">Edco Academy</h6>
                        ...
                        <a href="?page=quation" class="btn btn-edco">Enroll Now</a>
                    </div>
                    <div class="col-lg-7 order-1 order-lg-2" data-aos="fade-left">
                        <img src="assets/img/home-academy-preview.png" class="img-fluid rounded-4" alt="Edco Academy">
                    </div>
                </div>
            </div>
        </section>
